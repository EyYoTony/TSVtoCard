...
card_img = cv2.imread('C:\\Users\\aswan\PycharmProjects\CardGenerator\ActionCardArt\\test_dk.png')
...
txt_y = height-(border+desc_height) + 40
...
wrapped_text = textwrap.wrap(desc_text, width=20, break_long_words=False)
i = 0
...
cv2.imwrite('C:\\Users\\aswan\PycharmProjects\CardGenerator\ActionCardImgs\Test3.png', img)
cv2.waitKey(0)
